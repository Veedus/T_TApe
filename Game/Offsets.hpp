...
public:
    ...
    ulong inAttack = (0x0743d330 + 0x8); //[Buttons] in_attack=0x076782c8

    ulong level = 0x16fa230;//Miscellaneous LevelName=0x1462450

    ulong localPlayer = (0x22036C0 + 0x8); //0x1388eb8 //.?AVC_GameMovement@@=0x01ee8cb0

    ulong entityList = 0x1e53c68; //cl_entitylist=0x1b37938

    ulong viewRender = 0x743AAA0; //[Miscellaneous] ViewRender=0x7677288
    ulong viewMatrix = 0x11a350; //[Miscellaneous] ViewMatrix=0x11a210

    ulong lifeState = 0x0798; //m_lifeState=0x0798
    ulong bleedOutState = 0x2750; //m_bleedoutState=0x2740
    ...
    ulong lastVisibleTime = 0x1a70;
    ulong viewAngle = 0x25b4 - 0x14; //
    ulong weaponPunch = 0x24b8; //m_currentFrameLocalPlayer.m_vecPunchWeapon_Angle=0x24b0
    ...
    ulong studioHdr = 0x10e8; //CBaseAnimating!m_pStudioHdr=0x10f0
    ulong cameraPosition = 0x1f50; //[Miscellaneous] CPlayer!camera_origin=0x1f48
    ulong cameraAngles = 0x1f5c; //[Miscellaneous] CPlayer!camera_angles=0x1f54
    ulong name = 0x0589; //[RecvTable.DT_BaseEntity] m_iName
    ulong latestPrimaryWeapons = 0x1a14; //[RecvTable.DT_BaseCombatCharacter] m_latestPrimaryWeapons



    ulong highlightServerContextID = 0x03c0; //[RecvTable.DT_HighlightSettings] m_highlightServerContextID=0x03c0
    ulong glowEnable = 0x8; 
    ulong glowThroughWall = 0x10;
    ...
    ulong projectileSpeed = 0x1a70 + 0x4cc; //CWeaponX!m_flProjectileSpeed=0x1f18
    ulong projectileScale = 0x1a70 + 0x4d4; //CWeaponX!m_flProjectileScale=0x1f20
    ulong ammoInClip = 0x1660;
